...
<div class="container">
    <header class="blog-header py-3">
      <div class="row flex-nowrap justify-content-between align-items-center">
        ...
        <div class="col-4 text-center">
          <a class="blog-header-logo text-dark" href="/">FBlog</a>
        </div>
    ...
    <div class="nav-scroller py-1 mb-2">
      <nav class="nav d-flex justify-content-center">
        ...
        <a class="p-2 link-secondary" href="/posts?category={{ $category->name }}">{{ $category->name }}</a>
        @endforeach
      </nav>
    </div>
  </div>
      ...
      <div class="col-md-6">
        <div class="row g-0 border rounded overflow-auto flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          <div class="col p-4 d-flex flex-column position-static">
            ...
            <div class="mb-1 text-muted">{{ $posts[1]->created_at->diffForHumans() }}</div>
      ...
      <div class="col-lg-6">
        <div class="card mb-3" style="max-width: 540px;">
            <div class="row g-0">
              ...
              <div class="col-md-4">
                @if($posts[0]->image)
                <img src="{{ asset('storage/' . $posts[0]->image) }}" alt="{{ $posts[0]->category->name }}" class="img-fluid overflow-hidden rounded" style="height: 100%;">
                @else
                {{-- penting untuk diubah --}}
                <img src="http://source.unsplash.com/1200x400?{{ $posts[0]->category->name }}" class="img-fluid rounded-start" alt="{{ $posts[0]->category->name }}">
                @endif
              </div>
            </div>
        </div>
