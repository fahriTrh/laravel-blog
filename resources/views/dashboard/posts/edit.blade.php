...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="col-lg-8">
        <form action="/dashboard/posts/{{ $post->slug }}" method="post" enctype="multipart/form-data">
            ...
            @enderror
            <input id="article" type="hidden" name="article" value="{{ old('article', $post->article), $post->article }}">
            <trix-editor input="article" class="mb-3"></trix-editor>
            <button type="submit" class="btn btn-danger mb-5">Update Post</button>
        </form>
    </div>
</main>
<script>
